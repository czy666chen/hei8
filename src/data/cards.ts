...
const card = (id: number, title: string, effect: string, count = 1, needsReview = false): CardDefinition => ({
  id: `card-${String(id).padStart(3, "0")}`, title, effect, count, ...(needsReview ? { needsReview } : {}),
});
...
export const CARD_DEFINITIONS: CardDefinition[] = [
  ...
  card(38,"花里胡哨","对手下一杆必须用背后出杆的方式击打。"),
  ...
  card(45,"表白卡","对手下一杆由己方用“比心手势”的手架代替对手的手架。"),
