...
- 唯一正式 Worker `taiqiu-qizhao-cards` 已部署，三个生产 Secret 已独立配置；后续生产发布固定使用该名称。生产 D1 迁移、健康检查、匿名权限、错误邀请码和发布包能力冒烟均已通过。真实邀请码账号灰度与生产备份恢复演练已由产品负责人验收。球友/认领属于后续独立功能切片，不阻塞本次账号与单主写同步正式版。
